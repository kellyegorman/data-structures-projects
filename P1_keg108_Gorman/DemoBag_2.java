...
public class DemoBag_2 {
   ...
   */
  public <T> void removeAll(DualImplementationBag_2<T> bag, T element) {
   ...
   */
  public <T> void retainAll(DualImplementationBag_2<T> bag, T element) {
    for(int i = 0; i < bag.size(); i++) {
      if(!bag.get(i).equals(element)) {
        bag.remove(bag.get(i));
        i--;
   ...
   */
  public <T> DualImplementationBag_2<T> union(DualImplementationBag_2<T> otherBag1, 
               DualImplementationBag_2<T> otherBag2) {
    DualImplementationBag_2<T> newBag = new DualImplementationBag_2<T>(true);
   ...
   */
  public <T> DualImplementationBag_2<T> intersection(DualImplementationBag_2<T> otherBag1, 
                      DualImplementationBag_2<T> otherBag2) {
    DualImplementationBag_2<T> newBag = new DualImplementationBag_2<T>(true);
    for(int i = 0; i < otherBag1.size(); i++) {
   ...
   */
  public <T> DualImplementationBag_2<T> difference(DualImplementationBag_2<T> otherBag1, 
                    DualImplementationBag_2<T> otherBag2) {
    DualImplementationBag_2<T> newBag = new DualImplementationBag_2<T>(true);
    for(int i = 0; i < otherBag1.size(); i++) {
      newBag.add(otherBag1.get(i));
